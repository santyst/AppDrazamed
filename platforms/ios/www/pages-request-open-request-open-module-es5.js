...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-request-open-request-open-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesRequestOpenRequestOpenPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesRequestOpenRequestOpenRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RequestOpenPageRoutingModule", function () {
      return RequestOpenPageRoutingModule;
    });
    /* harmony import */
    ...
    var _request_open_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./request-open.page */
    ...
    var RequestOpenPageRoutingModule = function RequestOpenPageRoutingModule() {
      _classCallCheck(this, RequestOpenPageRoutingModule);
    };

    RequestOpenPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesRequestOpenRequestOpenModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RequestOpenPageModule", function () {
      return RequestOpenPageModule;
    });
    /* harmony import */
    ...
    var _request_open_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./request-open-routing.module */
    "./src/app/pages/request-open/request-open-routing.module.ts");
    /* harmony import */


    var _request_open_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./request-open.page */
    "./src/app/pages/request-open/request-open.page.ts");

    var RequestOpenPageModule = function RequestOpenPageModule() {
      _classCallCheck(this, RequestOpenPageModule);
    };

    RequestOpenPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _request_open_routing_module__WEBPACK_IMPORTED_MODULE_5__["RequestOpenPageRoutingModule"]],
  ...
  /***/
  function srcAppPagesRequestOpenRequestOpenPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesRequestOpenRequestOpenPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RequestOpenPage", function () {
      return RequestOpenPage;
    });
    /* harmony import */
    ...
    var RequestOpenPage = /*#__PURE__*/function () {
      function RequestOpenPage(iab, router, auth, route, http, config, menuCtrl) {
        var _this = this;

        _classCallCheck(this, RequestOpenPage);
        ...
        this.route.queryParams.subscribe(function (params) {
          if (_this.router.getCurrentNavigation().extras.state) {
            _this.orden = _this.router.getCurrentNavigation().extras.state.user;
            _this.cart_med = _this.orden.get_cart;
            _this.id = _this.orden.id;
            _this.status = _this.orden.status;
            console.log(_this.orden);
            console.log(_this.cart_med);
            _this.invoice_i = _this.cart_med[0].invoice_id;
            console.log(_this.invoice_i);

            _this.http.get("".concat(_this.base_url).concat(_this.payment_url).concat(_this.invoice_i, "/1?email=").concat(_this.userid)).subscribe(function (pay) {
              _this.ad = pay;
              _this.address = _this.ad.posted.address;
              _this.linkpay = _this.ad.preference.init_point;
            });
          }
        });
      }

      _createClass(RequestOpenPage, [{
        key: "ngOnInit",
        ...
        key: "goPago",
        value: function goPago() {
          this.iab.create(this.linkpay, '_blank');
        }
      }, {
        key: "getPrice",
        value: function getPrice() {
          return this.cart_med.reduce(function (i, j) {
            return i + j.total_price;
          }, 0);
        }
      }, {
        key: "getTotal",
        ...
        value: function getTax() {
          ...
          var _iterator = _createForOfIteratorHelper(this.cart_med),
              _step;
    ...
    RequestOpenPage.ctorParameters = function () {
      return [{
    ...
    RequestOpenPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
      selector: 'app-request-open',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./request-open.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/request-open/request-open.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./request-open.page.scss */
      "./src/app/pages/request-open/request-open.page.scss"))["default"]]
    })], RequestOpenPage);
    /***/
  }
}]);
//# sourceMappingURL=pages-request-open-request-open-module-es5.js.map