...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-carrito-carrito-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesCarritoCarritoPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesCarritoCarritoRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesCarritoCarritoModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesCarritoCarritoPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesCarritoCarritoPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CarritoPage = /*#__PURE__*/function () {
      function CarritoPage(router, menuCtrl, cartService, alertCtrl, camera, file, http, webview, actionSheetController, toastController, storage, plt, loadingController, ref, platform, auth, config) {
      ...
      _createClass(CarritoPage, [{
        ...
        value: function ionViewWillEnter() {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
            var _iterator, _step, formula, alert;
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _iterator = _createForOfIteratorHelper(this.cart);
                    _context2.prev = 7;
                  ...
                  case 9:
                    ...
                    this.text = "El medicamento ".concat(this.value || this.name || this.med, " requiere adjuntar f\xF3rmula m\xE9dica");
                    _context2.next = 18;
        ...
        value: function getSubTotal() {
          return this.cart.reduce(function (i, j) {
            return i + (j.unit_price * j.medicine_count || +j.mrp * j.medicine_count);
          }, 0);
        }
      }, {
        key: "getTotal",
        ...
        value: function foto() {
          ...
          this.camera.getPicture(options).then(function (imageData) {
            _this2.formulaImage = 'data:image/jpeg;base64,' + imageData;
          }, function (err) {
            console.log(err);
          });
        }
        ...
        value: function galeria() {
          ...
          this.camera.getPicture(options).then(function (imageData) {
            _this3.formulaImage = 'data:image/jpeg;base64,' + imageData;
          }, function (err) {
            console.log(err);
          });
        ...
        value: function send() {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
            ...
            var loading, _iterator3, _step3, code;
              ...
              while (1) {
                switch (_context7.prev = _context7.next) {
                  ...
                  case 5:
                    ...
                    this.http.post("".concat(this.base_url, "medicine/store-prescription/0"), this.orden, {
                              ...
                              case 5:
                                ...
                                return this.alertCtrl.create({
                                  ...
                                  buttons: [{
                                    ...
                                    cssClass: 'btnalert',
                                    handler: function handler(data) {
                                      _this5.router.navigate(['mispedidos']);
                                    }
                                  }]
                                });

                              case 8:
                                alert2 = _context6.sent;
                                this.http.get("".concat(this.base_url).concat(this.delete_cart).concat(this.userid)).subscribe(function (val) {
                                  console.log(val);
                                });
    ...
    CarritoPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/carrito/carrito.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./carrito.page.scss */
      "./src/app/pages/carrito/carrito.page.scss"))["default"]]
    })], CarritoPage);
    /***/
  }
}]);
