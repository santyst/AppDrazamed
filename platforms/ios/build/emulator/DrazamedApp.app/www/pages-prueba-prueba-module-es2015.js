...
let PruebaPage = class PruebaPage {
    constructor(router, route, config, menuCtrl, loadingController, alertCtrl, formBuilder, storage, tratamientoService, htpp, auth, http, plt) {
        this.router = router;
        this.route = route;
        this.config = config;
    ...
    createAlarm() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.http.post(`${this.base_url}treatment/create-treatment`, this.tratamiento).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["finalize"])(() => {
                loading.dismiss();
            }))
                .subscribe((msj) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                console.log(msj);
                this.response = msj;
                ...
                this.alarmas.buy_time = moment__WEBPACK_IMPORTED_MODULE_4__(this.medicamento.buy_time.date).format('ll');
    ...
    check(id) {
        ...
        let nowstart2 = moment__WEBPACK_IMPORTED_MODULE_4__(nowstart);
        let dateObjetive3 = moment__WEBPACK_IMPORTED_MODULE_4__(dateObjetive2);
        let endDate = moment__WEBPACK_IMPORTED_MODULE_4__(dateObjetive2).add(horas_totales, 'hours').format();
        let proxima = moment__WEBPACK_IMPORTED_MODULE_4__(endDate).subtract(48, 'hours').format('YYYY-MM-DD');
...
PruebaPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./prueba.page.scss */ "./src/app/pages/prueba/prueba.page.scss")).default]
    })
], PruebaPage);
