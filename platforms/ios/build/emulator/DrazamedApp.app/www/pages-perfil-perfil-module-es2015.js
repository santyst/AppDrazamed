...
let PerfilPage = class PerfilPage {
    constructor(menuCtrl, cartService, auth, alertCtrl, http, router, config, loadingController, tratamientoService, storage, platform) {
    ...
    proximaEntrega() {
        ...
        let prxFormatted = this.proxima.map(f => moment__WEBPACK_IMPORTED_MODULE_11__(f));
...
], PerfilPage.prototype, "slider", void 0);
