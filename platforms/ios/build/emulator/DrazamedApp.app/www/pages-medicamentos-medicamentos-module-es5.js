...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-medicamentos-medicamentos-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesMedicamentosMedicamentosPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesMedicamentosMedicamentosRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesMedicamentosMedicamentosModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesMedicamentosMedicamentosPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesMedicamentosMedicamentosPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var MedicamentosPage = /*#__PURE__*/function () {
      function MedicamentosPage(menuCtrl, router, http, cartService, config, route) {
        var _this = this;
      ...
      _createClass(MedicamentosPage, [{
        ...
        value: function getItems(ev) {
          ...
          if (val && val.trim() !== '') {
            ...
            this.http.get("".concat(this.base_url).concat(this.apiURL).concat(val)).subscribe(function (response) {
              _this2.meds = response;
              _this2.items = _this2.meds;
            });
          } else {
            this.isItemAvailable = false;
          }
        ...
        value: function fillSearchbarText(item) {
          ...
          console.log(item);
          this.http.get("".concat(this.base_url).concat(this.apiURL2).concat(item)).subscribe(function (res) {
            _this3.fullmed = res;
            _this3.fullmed1 = _this3.fullmed.data;
            _this3.fullmed2 = _this3.fullmed.data[0].is_pres_required;
            var navigationExtras = {
              state: {
                user: _this3.fullmed1,
                formula: _this3.fullmed2,
                fromProx: _this3.fromProx
              }
            };

            _this3.router.navigate(['resultsearch'], navigationExtras);
          });
          this.searchbarInput = '';
        }
      }]);
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], MedicamentosPage.prototype, "itemSelected", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('searchBarInput', {
      "static": true
    })], MedicamentosPage.prototype, "searchbarInput", void 0);
    MedicamentosPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-medicamentos',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./medicamentos.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/medicamentos/medicamentos.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./medicamentos.page.scss */
      "./src/app/pages/medicamentos/medicamentos.page.scss"))["default"]]
    })], MedicamentosPage);
    /***/
  }
}]);
//# sourceMappingURL=pages-medicamentos-medicamentos-module-es5.js.map