...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-resultsearch-resultsearch-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesResultsearchResultsearchPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesResultsearchResultsearchRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ResultsearchPageRoutingModule", function () {
      return ResultsearchPageRoutingModule;
    });
    /* harmony import */
    ...
    var _resultsearch_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./resultsearch.page */
    ...
    var ResultsearchPageRoutingModule = function ResultsearchPageRoutingModule() {
      _classCallCheck(this, ResultsearchPageRoutingModule);
    };

    ResultsearchPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesResultsearchResultsearchModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ResultsearchPageModule", function () {
      return ResultsearchPageModule;
    });
    /* harmony import */
    ...
    var _resultsearch_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./resultsearch-routing.module */
    "./src/app/pages/resultsearch/resultsearch-routing.module.ts");
    /* harmony import */


    var _resultsearch_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./resultsearch.page */
    "./src/app/pages/resultsearch/resultsearch.page.ts");

    var ResultsearchPageModule = function ResultsearchPageModule() {
      _classCallCheck(this, ResultsearchPageModule);
    };

    ResultsearchPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _resultsearch_routing_module__WEBPACK_IMPORTED_MODULE_5__["ResultsearchPageRoutingModule"]],
  ...
  /***/
  function srcAppPagesResultsearchResultsearchPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesResultsearchResultsearchPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ResultsearchPage", function () {
    ...
    var src_app_services_tratamientos_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/services/tratamientos.service */
    "./src/app/services/tratamientos.service.ts");

    var ResultsearchPage = /*#__PURE__*/function () {
      // tslint:disable-next-line: max-line-length
      function ResultsearchPage(route, http, cartService, menuCtrl, router, config, alertCtrl, tratamientoService, loadingController) {
        var _this = this;

        _classCallCheck(this, ResultsearchPage);
        ...
        this.route.queryParams.subscribe(function (params) {
          ...
          if (_this.router.getCurrentNavigation().extras.state) {
            ...
            _this.data1 = _this.router.getCurrentNavigation().extras.state.formula;
            _this.fromProx = _this.router.getCurrentNavigation().extras.state.fromProx;
            console.log('fromProx: ', _this.fromProx);
            console.log(_this.data);

            if (_this.data1 === 1) {
              _this.formul = ['Se requiere formula'];
            } else {
              _this.formul = ['No se requiere formula'];
            }
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                var imgg = _step.value;

                _this.http.get("".concat(_this.base_url).concat(_this.apiUrl7).concat(imgg.item_code).concat(_this.apiUrl8)).subscribe(function (val) {}, function (err) {
      ...
      _createClass(ResultsearchPage, [{
        ...
        value: function postData() {
          ...
          this.posteo.subscribe(function (data) {
            console.log(data);
          });
        }
      }]);
    ...
    ResultsearchPage.ctorParameters = function () {
      return [{
    ...
    ResultsearchPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-resultsearch',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./resultsearch.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/resultsearch/resultsearch.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./resultsearch.page.scss */
      "./src/app/pages/resultsearch/resultsearch.page.scss"))["default"]]
    })], ResultsearchPage);
    /***/
  }
}]);
//# sourceMappingURL=pages-resultsearch-resultsearch-module-es5.js.map