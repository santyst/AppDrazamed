...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-mispedidos-mispedidos-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesMispedidosMispedidosPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesMispedidosMispedidosRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MispedidosPageRoutingModule", function () {
      return MispedidosPageRoutingModule;
    });
    /* harmony import */
    ...
    var _mispedidos_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./mispedidos.page */
    ...
    var MispedidosPageRoutingModule = function MispedidosPageRoutingModule() {
      _classCallCheck(this, MispedidosPageRoutingModule);
    };

    MispedidosPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesMispedidosMispedidosModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MispedidosPageModule", function () {
      return MispedidosPageModule;
    });
    /* harmony import */
    ...
    var _mispedidos_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./mispedidos-routing.module */
    "./src/app/pages/mispedidos/mispedidos-routing.module.ts");
    /* harmony import */


    var _mispedidos_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./mispedidos.page */
    "./src/app/pages/mispedidos/mispedidos.page.ts");

    var MispedidosPageModule = function MispedidosPageModule() {
      _classCallCheck(this, MispedidosPageModule);
    };

    MispedidosPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _mispedidos_routing_module__WEBPACK_IMPORTED_MODULE_5__["MispedidosPageRoutingModule"]],
  ...
  /***/
  function srcAppPagesMispedidosMispedidosPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesMispedidosMispedidosPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MispedidosPage", function () {
    ...
    var MispedidosPage = /*#__PURE__*/function () {
      function MispedidosPage(iab, router, http, auth, menuCtrl, config, alertController, loadingController, tratamientoService) {
        var _this = this;

        _classCallCheck(this, MispedidosPage);
        ...
        this.orders = this.http.get("".concat(this.base_url, "my-prescriptions?email=").concat(this.userid)).subscribe(function (val) {
          _this.orden = val;

          var _iterator = _createForOfIteratorHelper(_this.orden),
              _step;

          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              var notVer = _step.value;

              if (notVer.status === 1 || notVer.status === 2) {
                _this.pendientes.push(notVer);
              } else if (notVer.status >= 4) {
                _this.completados.push(notVer);
              }
            }
          } catch (err) {
            _iterator.e(err);
          ...
          console.log('pendientes', _this.pendientes);
          console.log('completados', _this.completados);
        });
      }

      _createClass(MispedidosPage, [{
        key: "ngOnInit",
        ...
        key: "goClosed",
        value: function goClosed(completados) {
          var navigationExtras = {
            state: {
              user: completados
            }
        ...
        value: function goPago(orden) {
          ...
          this.http.get("".concat(this.base_url).concat(this.payment_url).concat(this.invoice_i, "/1?email=").concat(this.userid)).subscribe(function (pay) {
            _this2.ad = pay;
            _this2.address = _this2.ad.posted.address;
            _this2.linkpay = _this2.ad.preference.init_point;

            _this2.iab.create(_this2.linkpay, '_blank');
          });
        }
      }, {
        key: "removeOrder",
                              ...
                              while (1) {
                                switch (_context2.prev = _context2.next) {
                                  ...
                                  case 5:
                                    ...
                                    this.http.get("".concat(this.base_url, "user/pres-delete/").concat(order.id)).subscribe(function (val) {
                                      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this4, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                                        var _iterator2, _step2, _step2$value, index, p, alert2;
                                          ...
                                          while (1) {
                                            switch (_context.prev = _context.next) {
                                              case 0:
                                                ...
                                                loading.dismiss();
                                                _iterator2 = _createForOfIteratorHelper(this.pendientes.entries());

                                                try {
                                                  for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                                                    _step2$value = _slicedToArray(_step2.value, 2), index = _step2$value[0], p = _step2$value[1];
    ...
    MispedidosPage.ctorParameters = function () {
      return [{
    ...
    MispedidosPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
      selector: 'app-mispedidos',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./mispedidos.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/mispedidos/mispedidos.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./mispedidos.page.scss */
      "./src/app/pages/mispedidos/mispedidos.page.scss"))["default"]]
    })], MispedidosPage);
    /***/
  }
}]);
//# sourceMappingURL=pages-mispedidos-mispedidos-module-es5.js.map